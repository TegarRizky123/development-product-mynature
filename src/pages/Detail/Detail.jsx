...
const DetailArticle = () => {
    ...
    const getArticle = async (id) => {
        const response = await axios.get(`https://634c3a82acb391d34a818933.mockapi.io/artikel/${id}`);
...
{/* <h2>Judul: {article.title}</h2>
           <h2>Tanggal: {article.tanggal}</h2>
           <h2>Created at: {article.createdAt}</h2>
             <img src={article.images} />
             <h2>Deskripsi: {article.content}</h2> */}
